        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetTopicId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KnowledgeRelations_Topics_SourceTopicId",
                        column: x => x.SourceTopicId,
                        principalTable: "Topics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KnowledgeRelations_Topics_TargetTopicId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExportStyle = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PdfDocuments_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserBookmarks_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KnowledgeRelations_SourceTopicId",
                table: "KnowledgeRelations",
                column: "SourceTopicId");

            migrationBuilder.CreateIndex(
                name: "IX_KnowledgeRelations_TargetTopicId",
                table: "KnowledgeRelations",
                column: "TargetTopicId");

            migrationBuilder.CreateIndex(
                name: "IX_PdfDocuments_ArticleId",
                table: "PdfDocuments",
                column: "ArticleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingHistories_UserId_ArticleId",
                table: "ReadingHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBookmarks_ArticleId",
                table: "UserBookmarks",
                column: "ArticleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBookmarks_UserId_ArticleId",
                table: "UserBookmarks",
                columns: new[] { "UserId", "ArticleId" },
                unique: true);
